                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 md:gap-0">
                    ...
                    <div className="flex flex-col items-center md:items-end w-full md:w-1/3">
                        <div className="flex items-center gap-4">
                            <Link href="https://x.com/chainvolio" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-white/80 transition-colors">
                                <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor">
                                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                                </svg>
                            </Link>

                            <a href="#" onClick={(e) => e.preventDefault()} className="text-white/40 hover:text-white/80 transition-colors cursor-default">
                                <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor">
