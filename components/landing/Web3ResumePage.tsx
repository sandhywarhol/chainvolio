    ...
    return (
        <main className="min-h-screen bg-black text-white overflow-x-hidden">
            ...
            <section className="relative pt-40 pb-28 px-6 overflow-hidden">
                {/* Ambient glow */}
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[900px] h-[500px] bg-[radial-gradient(ellipse_at_center,rgba(20,241,149,0.06)_0%,transparent_70%)] pointer-events-none" />
                ...
                <div className="max-w-[1240px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                    ...
                    >
                        ...
                        <div className="space-y-5 text-white/40 text-base leading-relaxed font-medium">
                            ...
                            <p>
                                A <strong className="text-white/70">Web3 resume</strong> on ChainVolio is different. Every work experience is backed by an <strong className="text-emerald-400/80">on-chain attestation</strong> - a cryptographically signed record issued by the organization or peer that actually worked with you.
                            </p>
                            <p>
                    ...
                    >
                        ...
                        <div className="p-6 rounded-2xl bg-emerald-500/[0.04] border border-emerald-500/20">
                            <p className="text-[10px] font-black uppercase tracking-[0.2em] text-emerald-400 mb-4">Web3 Resume on ChainVolio</p>
                            <div className="space-y-3">
            ...
            <section className="py-32 px-6 border-t border-white/5 relative overflow-hidden">
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[300px] bg-[radial-gradient(ellipse_at_center,rgba(20,241,149,0.07)_0%,transparent_70%)] pointer-events-none" />
