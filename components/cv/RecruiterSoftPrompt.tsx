        ...
        <div className="fixed bottom-0 left-0 right-0 z-[9000] flex justify-center px-4 pb-4 animate-in slide-in-from-bottom-4 fade-in duration-300">
            <div className="w-full max-w-2xl bg-[#0d0d0f]/95 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl px-5 py-4 flex items-center justify-between gap-4">
                <div className="flex items-start gap-3 min-w-0">
                    <div className="flex-shrink-0 w-8 h-8 rounded-xl bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center mt-0.5">
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                    <button
                        ...
                        className="px-4 py-2 rounded-xl bg-emerald-500 hover:bg-emerald-400 text-white text-xs font-black uppercase tracking-widest transition-all whitespace-nowrap"
                    >
                        Sign In Free
                    </button>
                    <button
