    ...
    return (
        <main className="min-h-screen flex flex-col relative overflow-x-hidden selection:bg-amber-500/30 selection:text-white bg-black theme-bg-page theme-aware">
            ...
            <div className="fixed inset-0 pointer-events-none z-0">
                <div className="absolute top-[10%] -left-[5%] w-[45%] h-[45%] bg-white/[0.015] blur-[140px] rounded-full" />
                <div className="absolute bottom-[20%] -right-[5%] w-[40%] h-[40%] bg-white/[0.01] blur-[140px] rounded-full" />
            </div>
            ...
            <section className="relative z-40 pt-24 pb-20 px-8 max-w-[1240px] mx-auto w-full text-center">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-white/[0.08] bg-white/[0.02] mb-8">
                    ...
                    <span className="text-caption text-amber-200/60">Screening Protocol</span>
                </div>
            ...
            <section className="relative z-40 pb-32 px-8">
                <div className="max-w-[1240px] mx-auto space-y-32">
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 pt-24">
                        <div className="group space-y-10 p-8 rounded-2xl bg-white/[0.01] border border-white/[0.03] hover:border-white/10 transition-all duration-500">
                            <div className="flex items-center gap-3">
                                <div className="p-2 rounded-lg bg-white/[0.04] text-white/40">
                                    <ShieldCheck className="w-5 h-5" />
                                </div>
                                <span className="text-caption text-amber-200/60">01 Authority</span>
                            </div>
                            <div className="space-y-6">
                                ...
                                <div className="p-8 bg-black/20 border border-white/[0.05] rounded-2xl relative overflow-hidden">
                                    <div className="absolute top-0 right-0 w-24 h-24 bg-white/[0.02] blur-2xl opacity-50 group-hover:bg-white/[0.04] transition-colors" />
                        ...
                        <div className="group space-y-10 p-8 rounded-2xl bg-white/[0.01] border border-white/[0.03] hover:border-white/10 transition-all duration-500">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-caption text-white/40">02 Substance</span>
                            </div>
                            <div className="space-y-6">
                    ...
                    <div className="space-y-16 pt-32 border-t border-white/5">
                        <div className="max-w-2xl">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <span className="text-caption text-white/40 block">Execution Layer</span>
                            </div>
                            ...
                            {[
                                ...
                                <div key={s.id} className="p-8 rounded-2xl bg-white/[0.01] border border-white/[0.03] flex flex-col gap-6 hover:bg-white/[0.02] hover:border-white/10 transition-all duration-300 group">
                                    <div className="flex justify-between items-center text-white/20">
                                        <div className="p-2 rounded-lg bg-white/[0.03] group-hover:bg-white/[0.08] group-hover:text-white/60 transition-all">
                                            {s.icon}
                                        </div>
                                    ...
                                    <div className="pt-4 border-t border-white/[0.05] space-y-3">
                                        <p className="text-[9px] text-white/30 uppercase tracking-[0.3em] font-bold">Map To Dashboard:</p>
                                        <ul className="space-y-2">
                                            {s.metrics.map(m => (
                                                <li key={m} className="text-body text-[11px] flex items-center gap-2 font-medium">
                                                    <span className="w-1 h-3 bg-white/10 rounded-full shrink-0 group-hover:bg-white/25 transition-colors" />
                                                    {m}
                                                </li>
                                            ))}
                                        </ul>
                    ...
                    <div className="bg-white/[0.02] rounded-2xl p-12 border border-white/[0.08] flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden group">
                        <div className="absolute top-0 right-0 w-64 h-64 bg-white/[0.02] blur-[80px] opacity-50 group-hover:bg-white/[0.04] transition-all pointer-events-none" />
                        <div className="absolute -bottom-10 -left-10 w-48 h-48 bg-white/[0.01] blur-[80px] opacity-50 pointer-events-none" />

                        <div className="space-y-4 relative z-10 max-w-xl">
                            <h2 className="text-h2">Evaluate Talent with Dashboard <span className="text-amber-200/60">Metrics.</span></h2>
