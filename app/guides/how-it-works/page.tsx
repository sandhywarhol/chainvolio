...
export default function HowItWorksPage() {
  return (
    <main className="h-screen flex flex-col relative selection:bg-teal-500/30 selection:text-white overflow-x-hidden bg-[#050505]">
      ...
      <div className="fixed inset-0 opacity-[0.012] pointer-events-none z-[100]" style={{ backgroundImage: `url("data:image/svg+xml,%3Csvg viewBox='0 0 200 200' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='noiseFilter'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.65' numOctaves='3' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23noiseFilter)'/%3E%3C/svg%3E")` }}></div>

      {/* Ambient Background Glows */}
      <div className="fixed inset-0 pointer-events-none z-0">
          <div className="absolute top-[10%] -left-[5%] w-[45%] h-[45%] bg-emerald-500/[0.04] blur-[150px] rounded-full" />
          <div className="absolute bottom-[15%] -right-[5%] w-[40%] h-[40%] bg-blue-500/[0.04] blur-[150px] rounded-full" />
          <div className="absolute top-[40%] left-[20%] w-[30%] h-[30%] bg-purple-500/[0.02] blur-[120px] rounded-full" />
      </div>
