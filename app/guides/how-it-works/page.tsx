  ...
  return (
    <main className="h-screen flex flex-col relative selection:bg-amber-500/30 selection:text-white overflow-x-hidden bg-black">
      ...
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
          <div className="absolute top-[10%] -left-[10%] w-[50%] h-[50%] bg-white/[0.015] blur-[160px] rounded-full" />
          ...
          <div className="flex-1 overflow-y-auto h-full px-8 lg:px-12 py-12 space-y-32 scrollbar-hide scroll-smooth pb-32">
            ...
            <header id="overview" className="space-y-8 scroll-mt-[120px]">
              <div className="flex items-center gap-3 px-4 py-1.5 bg-white/[0.02] border border-white/[0.08] rounded-full w-fit">
                ...
                <span className="text-caption text-amber-200/60">System Documentation</span>
              </div>
              <h1 className="text-h1">
                  How It <span className="text-white/20">Works.</span>
              </h1>
              <div className="space-y-6 max-w-3xl">
                <p className="text-body text-xl italic border-l-2 border-white/20 pl-8 bg-white/[0.01] py-6 rounded-r-3xl">
              ...
              <div className="space-y-12">
                {[
                  ...
                  <div key={i} className="flex gap-8 group">
                    <div className="flex-shrink-0 w-12 h-12 rounded-2xl bg-white/[0.02] border border-white/5 flex items-center justify-center text-white/40 font-mono font-bold group-hover:border-white/20 transition-all shadow-2xl">
                      {item.step}
                    </div>
                    <div className="space-y-2">
                      <h3 className="text-xl font-bold text-white group-hover:text-amber-200/60 transition-colors uppercase tracking-tight">{item.title}</h3>
            ...
            <section id="features" className="space-y-12 scroll-mt-[120px]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {[
                    { icon: <ShieldCheck className="w-5 h-5" />, title: "Zero-Knowledge Claims", desc: "Anchor your professional milestones without revealing sensitive project details. Our system supports private verification triggers for corporate confidentiality." },
                    { icon: <Zap className="w-5 h-5" />, title: "Instant Signal Screening", desc: "Recruiters use our API and dashboard to filter thousands of candidates based on verified skills, eliminating 90% of manual due diligence." },
                    { icon: <Award className="w-5 h-5" />, title: "Institutional Trust Issuers", desc: "Top Web3 organizations act as 'Trust Issuers,' providing high-authority attestations that carry significant weight in the talent market." },
                    { icon: <FileCheck className="w-5 h-5" />, title: "Portable Reputation", desc: "Your identity is stored on-chain. If ChainVolio ever disappears, your proofs and attestations remain accessible on the Solana network." }
                ].map((item, i) => (
                    <div key={i} className="p-10 bg-white/[0.01] border border-white/[0.03] rounded-2xl space-y-6 hover:border-white/10 transition-all group relative overflow-hidden">
                      <div className="absolute top-0 left-0 w-full h-[1px] bg-gradient-to-r from-transparent via-white/5 to-transparent group-hover:via-white/15 transition-all" />
                      <div className="p-4 rounded-2xl bg-white/[0.03] text-white/40 group-hover:bg-white/[0.06] group-hover:text-white/70 transition-colors w-fit shadow-xl">
                        {item.icon}
                      </div>
              ...
              <div className="space-y-20">
                <div id="hiring-flow-detail" className="space-y-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {[
                      ...
                      <div key={idx} className="p-8 rounded-2xl bg-white/[0.02] border border-white/5 space-y-4 hover:bg-white/[0.04] transition-colors group">
                        <div className="w-10 h-10 rounded-xl bg-white/[0.06] flex items-center justify-center text-white/50 font-bold group-hover:scale-110 transition-transform">{s.step}</div>
                ...
                <div id="candidate-evaluation" className="space-y-8">
                  ...
                  <div className="grid md:grid-cols-2 gap-12">
                    <div className="space-y-4">
                      <h4 className="text-amber-200/60 text-sm font-bold uppercase tracking-widest">Authority Score</h4>
                      <p className="text-body opacity-60 leading-relaxed">
                    ...
                    <div className="space-y-4">
                      <h4 className="text-white/40 text-sm font-bold uppercase tracking-widest">Signal Density</h4>
                      <p className="text-body opacity-60 leading-relaxed">
                ...
                <div id="attestation-advantage" className="space-y-12 border-t border-white/5 pt-12">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                      {[
                          ...
                          {
                              icon: <Magnet className="w-5 h-5 text-white/40" />,
                          ...
                          {
                              icon: <Globe className="w-5 h-5 text-amber-200/60" />,
                          ...
                          <div key={i} className="p-8 rounded-2xl bg-white/[0.02] border border-white/5 space-y-6 hover:bg-white/[0.04] transition-all group overflow-hidden relative">
                              <div className="absolute top-0 left-0 w-full h-[1px] bg-gradient-to-r from-transparent via-white/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
                              ...
                              <ul className="space-y-3">
                                  {block.items.map((item, j) => (
                                      <li key={j} className="flex gap-3 text-xs text-white/30 leading-relaxed font-medium">
                  ...
                  <div className="p-8 rounded-2xl bg-white/[0.02] border border-white/[0.08] text-center">
                      <p className="text-amber-200/60 font-bold italic text-sm">
                ...
                <div id="attestation-usage" className="space-y-8 border-t border-white/5 pt-12">
                   <div className="flex flex-col md:flex-row gap-12 items-center">
                      ...
                      <div className="w-full md:w-1/3 p-8 bg-white/[0.02] border border-white/[0.08] rounded-2xl text-center group">
                          <p className="text-amber-200/60 font-bold text-sm mb-2 group-hover:scale-110 transition-transform">Verification Hub</p>
            ...
            <section id="build-profile" className="space-y-12 scroll-mt-[120px]">
              ...
              <div className="space-y-20">
                ...
                <div id="get-attested" className="space-y-8 border-t border-white/5 pt-12">
                  <div className="flex items-center gap-6 p-10 bg-white/[0.02] border border-white/[0.08] rounded-2xl group">
                    <div className="hidden md:flex w-20 h-20 rounded-2xl bg-white/[0.03] items-center justify-center text-white/40 group-hover:scale-110 transition-transform flex-shrink-0">
