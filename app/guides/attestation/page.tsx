                ...
                <div className="max-w-[1240px] mx-auto space-y-32">
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 pt-24">
                        <div className="space-y-10 group/section">
                            ...
                            <div className="space-y-8 p-8 rounded-3xl bg-white/[0.01] border border-white/[0.03] hover:border-emerald-500/10 transition-all duration-500">
                        ...
                        <div className="space-y-10">
                            ...
                            <div className="p-10 bg-white/[0.02] border border-white/[0.03] rounded-3xl space-y-12 relative overflow-hidden group shadow-[0_10px_40px_rgba(16,185,129,0.02)]">
                    ...
                    <div className="space-y-16 pt-32 border-t border-white/5">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
                            {[
                                ...
                                <div key={s.step} className="p-8 bg-white/[0.01] border border-white/[0.03] rounded-3xl flex flex-col gap-8 hover:bg-white/[0.02] hover:border-white/10 transition-all duration-300 group">
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 pt-32 border-t border-white/5">
                        <div className="space-y-10">
                            ...
                            <div className="p-8 rounded-3xl bg-white/[0.01] border border-white/[0.03] group hover:border-emerald-500/20 transition-all duration-500">
                        ...
                        <div className="space-y-10">
                            ...
                            <div className="p-8 rounded-3xl bg-white/[0.01] border border-white/[0.03] group hover:border-blue-500/20 transition-all duration-500">
                                <div className="flex gap-8 group items-start">
