    ...
    return (
        <main className="min-h-screen flex flex-col relative overflow-x-hidden selection:bg-amber-500/30 selection:text-white bg-black theme-bg-page theme-aware">
            ...
            <div className="fixed inset-0 pointer-events-none z-0">
                <div className="absolute top-[12%] -left-[5%] w-[40%] h-[40%] bg-white/[0.015] blur-[130px] rounded-full" />
                <div className="absolute bottom-[25%] -right-[5%] w-[35%] h-[35%] bg-white/[0.01] blur-[130px] rounded-full" />
            </div>
            ...
            <section className="relative z-40 pt-24 pb-20 px-8 max-w-[1240px] mx-auto w-full text-center">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-white/[0.08] bg-white/[0.02] mb-8">
                    ...
                    <span className="text-caption text-amber-200/60">Proof Standards</span>
                </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 pt-24">
                        <div className="space-y-10 group/section">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-caption text-amber-200/60">The Attestation Primitive</span>
                            </div>
                            <div className="space-y-8 p-8 rounded-2xl bg-white/[0.01] border border-white/[0.03] hover:border-white/10 transition-all duration-500">
                        ...
                        <div className="space-y-10">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-caption text-white/40">Recruiter Insights</span>
                            </div>
                            <div className="p-10 bg-white/[0.02] border border-white/[0.03] rounded-2xl space-y-12 relative overflow-hidden group">
                                <div className="absolute top-0 right-0 w-32 h-32 bg-white/[0.02] blur-2xl opacity-50 group-hover:bg-white/[0.04] transition-all" />
                                <div className="space-y-6 relative z-10">
                                    <div className="flex justify-between items-end border-b border-white/[0.05] pb-6">
                                        <div className="space-y-3">
                                            ...
                                            <p className="text-h3 text-amber-200/60">Attested Output</p>
                                        </div>
                                        <ShieldCheck className="w-8 h-8 text-white/20 group-hover:text-white/50 transition-all" />
                                    </div>
                    ...
                    <div className="space-y-16 pt-32 border-t border-white/5">
                        <div className="max-w-2xl">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <span className="text-caption text-amber-200/60 block">Attestation Path</span>
                            </div>
                            ...
                            {[
                                ...
                                <div key={s.step} className="p-8 bg-white/[0.01] border border-white/[0.03] rounded-2xl flex flex-col gap-8 hover:bg-white/[0.02] hover:border-white/10 transition-all duration-300 group">
                                    <div className="flex justify-between items-center text-white/20">
                                        <div className="p-3 rounded-xl bg-white/[0.03] group-hover:bg-white/[0.08] group-hover:text-white/60 transition-all">
                                            {s.icon}
                                        </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 pt-32 border-t border-white/5">
                        <div className="space-y-10">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-caption text-amber-200/60">Verification Economics</span>
                            </div>
                            <div className="p-8 rounded-2xl bg-white/[0.01] border border-white/[0.03] group hover:border-white/10 transition-all duration-500">
                                    ...
                                    <div className="space-y-4 pt-1">
                                        ...
                                        <div className="space-y-6">
                                            ...
                                            <div className="p-8 bg-black/20 border border-white/[0.05] rounded-2xl relative overflow-hidden">
                                                <div className="absolute top-0 right-0 w-24 h-24 bg-white/[0.02] blur-2xl opacity-50" />
                        ...
                        <div className="space-y-10">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-caption text-white/40">Universal Audit</span>
                            </div>
                            <div className="p-8 rounded-2xl bg-white/[0.01] border border-white/[0.03] group hover:border-white/10 transition-all duration-500">
                                <div className="flex gap-8 group items-start">
