    ...
    return (
        <main className="min-h-screen flex flex-col relative overflow-x-hidden selection:bg-emerald-500/30 selection:text-white">
            ...
            <section className="relative z-40 pt-24 pb-20 px-8 max-w-[1240px] mx-auto w-full text-center">
                ...
                <h1 className="text-5xl md:text-7xl font-bold font-display tracking-tighter text-white leading-[0.85] mb-12">
                    System Status
                </h1>
            ...
            {/* Status Grid */}
            <section className="relative z-40 py-24 px-8 max-w-2xl mx-auto w-full">
                ...
                <div className="mt-16 p-8 border-l border-white/10 bg-white/[0.01]">
                ...
                <div className="mt-20 pt-8 border-t border-white/5 flex justify-between items-center text-[10px] font-bold uppercase tracking-[0.4em] text-white/20">
