...
const TIERS = [
    ...
    },
    {
        ...
        benefits: [
            ...
            { label: "Endorsements carry more weight across the ecosystem" },
            { label: "Trusted & recognized identity across protocols and DAOs" },
    ...
    },
    {
        ...
        benefits: [
            ...
            { label: "DAO identity recognized across partner protocols" },
        ],
    },
    {
        id: "Company",
