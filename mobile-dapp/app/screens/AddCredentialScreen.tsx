...
const styles = StyleSheet.create({
  ...
  sectionHeader: { color: 'rgba(255,255,255,0.2)', fontSize: 9, fontFamily: 'Inter-Bold', letterSpacing: 2 },
  inputGroup: { gap: 10 },
  label: { color: 'rgba(255,255,255,0.15)', fontSize: 8, fontFamily: 'Inter-Bold', letterSpacing: 1 },
  input: { height: 50, backgroundColor: 'rgba(255,255,255,0.02)', borderWidth: 1, borderColor: 'rgba(255,255,255,0.05)', borderRadius: 14, px: 16, color: '#fff', fontSize: 14, fontFamily: 'Inter-Bold' },
  ...
  uploadText: { color: 'rgba(255,255,255,0.4)', fontSize: 12, fontFamily: 'Inter-Bold' },
  ...
  submitBtnText: { color: '#fff', fontSize: 13, fontFamily: 'SpaceGrotesk-Bold', letterSpacing: 1 },
  ...
  countText: { color: 'rgba(255,255,255,0.3)', fontSize: 9, fontFamily: 'Inter-Bold' },
  emptyText: { color: 'rgba(255,255,255,0.1)', fontSize: 12, fontFamily: 'Inter-Bold', textAlign: 'center', marginTop: 10 },
  certsGrid: { gap: 12 },
  ...
  certInfo: { flex: 1 },
  certTitle: { color: '#fff', fontSize: 13, fontFamily: 'Inter-Bold' },
  certIssuer: { color: 'rgba(255,255,255,0.2)', fontSize: 10, fontFamily: 'Inter-Bold', marginTop: 2 },
