                ...
                {!submitted ? (
                    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        <header className="text-center mb-12">
                            <h1 className="text-4xl md:text-5xl font-extrabold mb-10 pb-4 tracking-tight leading-normal bg-gradient-to-br from-white to-slate-400 bg-clip-text text-transparent">
                                {collection.title}
                            </h1>
                            <div className="flex flex-wrap items-center justify-center gap-4 text-xs font-bold uppercase tracking-[0.2em] text-slate-500">
                                ...
                                {collection.metadata?.isTrusted && (
                                    <>
                                        <span className="w-1 h-1 rounded-full bg-slate-800"></span>
                                        <span className="flex items-center gap-2 px-2.5 py-1 bg-emerald-500/10 border border-emerald-500/20 rounded-md text-emerald-400 shadow-[0_0_15px_rgba(16,185,129,0.05)]">
                                            <BadgeCheck className="w-3.5 h-3.5" />
                                            <div className="flex flex-col text-left leading-[1] gap-0.5">
                                                ...
                                                <span className="text-[7px] font-bold text-emerald-400/60 uppercase tracking-widest">{getVerificationLabel(collection.metadata.verificationTier)}</span>
                                            </div>
                                        </span>
                                    </>
                                )}
